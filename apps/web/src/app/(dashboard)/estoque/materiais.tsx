  ...
  return (
    <PageTransition className="flex flex-col gap-8 h-full overflow-auto p-4 md:p-1 max-w-6xl mx-auto pb-12">
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        >
          <AlertTriangle size={14} strokeWidth={3} /> {belowMin ? 'Filtrando: Críticos' : 'Estoque Crítico'}
        </button>
      </div>
      ...
      <ScaleIn>
        {isLoading ? (
          <div className="p-20 flex flex-col items-center justify-center gap-4">
             ...
             <Muted className="animate-pulse font-black uppercase tracking-[0.2em]">Sincronizando inventário...</Muted>
          </div>
        ) : (
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-border bg-muted/30">
                  <th className="text-left text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] px-6 py-4">Insumo / Material</th>
                  <th className="text-left text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] px-6 py-4">SKU / Identificador</th>
                  <th className="text-left text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] px-6 py-4">Unidade</th>
                  <th className="text-center text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] px-6 py-4">Nível de Estoque</th>
                  <th className="text-right text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] px-6 py-4">Estoque Mín.</th>
                ...
                {materials.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="px-6 py-20">
                       ...
                       >
                          <button onClick={() => { setSearch(''); setBelowMin(false); }} className="text-[10px] font-black uppercase tracking-widest text-primary hover:underline">Limpar filtros</button>
                       </EmptyState>
                    </td>
                  </tr>
                ) : (
                      ...
                      <tr key={mat.id} className="group hover:bg-primary/[0.02] transition-colors">
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col gap-0.5">
                               <p className={cn("text-sm font-black tracking-tight", isLow ? "text-destructive" : "text-foreground")}>{mat.name}</p>
                               {isLow && <span className="text-[9px] font-black uppercase tracking-widest text-destructive/60 animate-pulse">Reposição Urgente</span>}
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-5 text-center">
                           <div className="flex flex-col items-center gap-2">
                              <Large className={cn("font-black tracking-tighter text-lg leading-none", isLow ? "text-destructive" : "text-foreground")}>
                                {stock}
                              </Large>
          ...
          <ScaleIn className="w-full max-w-xl">
            <div className="premium-card p-10 flex flex-col gap-10 relative shadow-2xl border-primary/20 overflow-hidden">
               ...
               <div className="flex justify-between items-start relative">
                 <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <Muted className="text-[10px] font-black uppercase tracking-[0.2em]">Cadastro técnico de insumo</Muted>
                    </div>
                 </div>
                 <button 
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
                 <div className="md:col-span-2">
                    ...
                    <div className="relative">
                       ...
                       />
                       <Box className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground/30 opacity-50" size={18} />
                    </div>
                 </div>
                 ...
                 <div>
                    ...
                    <div className="relative">
                       <input 
                         ...
                         className={inputClass} 
                       />
                       <Tag className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground/30 opacity-50" size={18} />
                    </div>
                 </div>
                 ...
                 <div>
                    ...
                    <div className="relative">
                       <input 
                         ...
                         className={inputClass} 
                       />
                       <Ruler className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground/30 opacity-50" size={18} />
                    </div>
                 </div>
                 ...
                 <div className="md:col-span-2">
                    ...
                    <div className="relative">
                       ...
                       />
                       <AlertCircle className="absolute right-4 top-1/2 -translate-y-1/2 text-primary opacity-50" size={20} />
                    </div>
               ...
               <div className="flex gap-4 pt-6 mt-4 border-t border-border/50 relative">
                  ...
                  >
                    {createMaterial.isPending ? <Loader2 size={16} className="animate-spin" /> : <><Plus size={16} strokeWidth={3} /> Confirmar Cadastro</>}
                  </button>
               </div>
            </div>
          </ScaleIn>
