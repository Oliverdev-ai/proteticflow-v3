...
const QUICK_LINKS = [
  {
    ...
    desc: 'Controle de saldo, lotes e validade',
    icon: Box,
    color: 'text-primary',
    bg: 'bg-primary/10',
  },
...
export default function InventoryDashboard() {
  ...
  const totalValue = dash
    ? (dash.totalValueCents / 100).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })
    : 'R$ 0,00';
      ...
      {!isLoading && (dash?.totalMaterials ?? 0) === 0 && (
        <div className="mt-4 p-8 bg-primary/5 border-2 border-dashed border-primary/20 rounded-[40px] flex flex-col items-center text-center gap-4 animate-in zoom-in-95">
          ...
          <div className="max-w-md space-y-2">
            ...
            <Subtitle>
              Comece cadastrando seus materiais básicos para habilitar alertas inteligentes e
