    ...
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] gap-6">
        <div className="relative">
           ...
           <Settings2 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-primary" size={24} />
        </div>
        <Muted className="font-black uppercase tracking-[0.3em] animate-pulse">Sincronizando Preferências...</Muted>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] gap-6">
        ...
        <div className="text-center space-y-2">
           <Large className="text-destructive font-black tracking-tight text-xl">Acesso Restrito</Large>
           <Muted className="text-[10px] font-black uppercase tracking-[0.2em] max-w-xs mx-auto opacity-60">
              Você não possui níveis de privilégio suficientes para acessar o núcleo de configurações globais.
           </Muted>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] gap-6">
        ...
        <div className="text-center space-y-2">
           ...
           <Muted className="text-[10px] font-black uppercase tracking-[0.2em]">Erro de sincronismo: {overview.error.message}</Muted>
        </div>
      </div>
    );
  }
    ...
    <PageTransition className="flex flex-col gap-10 h-full overflow-auto p-4 md:p-1 max-w-7xl mx-auto pb-16">
      ...
      <ScaleIn className="flex flex-wrap items-center justify-between gap-6">
        <div className="flex flex-col gap-1">
          ...
          <Subtitle>Gerencie o motor operacional, identidade visual e regras de negócio do laboratório</Subtitle>
        </div>
      </ScaleIn>
      ...
      <ScaleIn delay={0.2} className="bg-muted/30 border border-border/50 rounded-[32px] p-8 flex items-start gap-6 mt-4">
         ...
         <div className="flex flex-col gap-2">
            <span className="text-xs font-black text-foreground uppercase tracking-tight leading-none">Protocolo de Integridade Síncrona</span>
            <p className="text-[11px] text-muted-foreground leading-relaxed uppercase tracking-tight font-bold opacity-60">
              As definições efetuadas neste painel são propagadas em tempo real (Push-Sync) para todos os terminais ativos da organização, garantindo conformidade operacional imediata.
            </p>
         </div>
      </ScaleIn>
    </PageTransition>
