      ...
      <div className="flex flex-wrap items-center justify-between gap-6">
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col gap-0.5">
            <PageTitle className="tracking-tight">Contas a Receber</PageTitle>
                  ...
                  rows.map(({ ar, clientName }) => (
                    <tr key={ar.id} className="group hover:bg-primary/[0.02] transition-colors">
                      ...
                      <td className="px-6 py-5 text-right">
                        <Large className="text-success font-semibold tracking-tighter text-lg leading-none">
                      ...
                      <td className="px-6 py-5 text-right">
                        <div className="flex items-center justify-end gap-2 group-hover:translate-x-0 translate-x-4 opacity-0 group-hover:opacity-100 transition-all duration-300">
                          ...
                          <Link
                            ...
                            className="h-10 w-10 flex items-center justify-center bg-muted text-muted-foreground hover:text-primary hover:border-primary/50 border border-border rounded-xl transition-all "
            ...
            <div className="premium-card p-10 flex flex-col gap-10 relative shadow-md border-destructive/20 overflow-hidden">
              ...
              <div className="flex justify-between items-start relative">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-0.5">
                    <PageTitle className="text-2xl tracking-tighter">Cancelar Fatura</PageTitle>
