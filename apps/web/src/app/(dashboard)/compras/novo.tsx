    ...
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex justify-end gap-3 pb-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-medium text-sm shadow-md shadow-sm transition-all hover:scale-[1.02] disabled:opacity-60 disabled:scale-100"
        >
