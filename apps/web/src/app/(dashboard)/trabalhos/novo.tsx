...
export default function JobCreatePage() {
  ...
  const labelClass =
    'block text-[10px] font-semibold text-muted-foreground uppercase tracking-normal mb-2 ml-1';
    ...
    <PageTransition className="flex flex-col gap-8 h-full overflow-auto p-4 md:p-1 max-w-5xl mx-auto pb-32">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex flex-col gap-0.5">
          <PageTitle className="tracking-tight">Iniciando OS</PageTitle>
              ...
              {i < STEPS.length - 1 && (
                <div
                  className={cn(
                    ...
                    i < step ? 'bg-success/50' : 'bg-muted/50',
                  )}
                />
              )}
            </div>
      ...
      <div className="premium-card p-2 min-h-[500px] relative overflow-hidden">
        ...
        {step === 0 && (
          <ScaleIn className="p-8 flex flex-col gap-10">
            ...
            <div className="p-10 rounded-lg bg-primary/[0.02] border border-primary/20 relative overflow-hidden group">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={cn(inputClass, 'text-lg font-semibold tracking-normal tabular-nums')}
                    />
                    <Hash
              ...
              <div className="flex items-center justify-between ml-1 border-b border-border/50 pb-4">
                ...
                {!clientId && osNumber && (
                  <div className="flex items-center gap-2 px-3 py-1 bg-amber-500/10 border border-amber-500/20 rounded-full animate-pulse">
                    ...
                    <span className="text-[9px] font-semibold uppercase tracking-normal text-amber-500">
                      Buscando Registro...
                    </span>
                  </div>
                )}
                  ...
                  <div className="md:col-span-2 p-6 rounded-lg bg-success/[0.03] border-2 border-success ring-4 ring-emerald-500/10 flex items-center justify-between shadow-md animate-in zoom-in-95 duration-500">
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex flex-col gap-1">
                        <span className="text-[10px] font-semibold text-success uppercase tracking-normal">
                          Parceiro Identificado na OS #{osNumber}
                        </span>
                        <Large className="text-2xl font-semibold tracking-tighter leading-none">
                          {resolveQuery.data.clientName}
                        </Large>
                      </div>
                    </div>
                    <button className="text-[10px] font-semibold uppercase tracking-normal text-success hover:brightness-110 transition-all">
                      Trocar Parceiro
                    </button>
                  </div>
                )}
                ...
                {!resolveQuery.data &&
                  clientsData?.data.map((c) => (
                    ...
                    >
                      <div
                        className={cn(
                          'w-12 h-12 flex items-center justify-center rounded-lg border transition-all duration-500 shadow-inner',
                          clientId === c.id
            ...
            <div className="flex items-center justify-between pb-8 border-b border-border/50 relative">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <Muted className="text-[10px] font-semibold uppercase tracking-normal">
                    Seleção técnica e valoração parcial
                  </Muted>
                </div>
              </div>
              ...
              <div className="flex flex-col items-end gap-1">
                ...
                <Large className="text-3xl font-semibold text-primary tracking-tighter tabular-nums leading-none">
              ...
              <div className="md:col-span-4 space-y-6">
                <div className="flex flex-col gap-2">
                  ...
                  <div className={cn(inputClass, 'px-5 py-4')}>
                    ...
                    <p className="mt-1 text-[10px] font-bold uppercase tracking-normal text-muted-foreground">
                ...
                {selectedClientPricingTableId && (
                  <div className="flex flex-col gap-2 max-h-[300px] overflow-y-auto pr-1 custom-scrollbar">
                    <Muted className="text-[9px] font-bold uppercase tracking-normal ml-1 mb-1">
                      Itens Disponíveis
                    </Muted>
                    {priceItemsData?.data.map((pi) => (
                      <button
                        ...
                        className="group flex items-center justify-between p-4 rounded-lg border border-border bg-muted/20 hover:border-primary/50 hover:bg-primary/[0.03] transition-all text-left shadow-sm "
                      >
                        <div className="flex flex-col gap-0.5">
                          <span className="text-[11px] font-semibold text-foreground group-hover:text-primary transition-colors tracking-tight leading-tight">
                            {pi.name}
                          </span>
                  ...
                  {items.length > 0 ? (
                      ...
                      >
                        ...
                        <div className="flex-1 flex flex-col gap-1">
                          <input
                            ...
                            className="w-full bg-transparent border-none text-sm font-semibold text-foreground placeholder:text-muted-foreground/30 focus:ring-0 p-0"
                          />
                          <div className="flex items-center gap-4">
                            <div className="flex items-center gap-2">
                              ...
                              <input
                                ...
                                min="1"
                                className="w-12 bg-muted/40 border-none rounded-lg text-xs font-semibold text-center text-foreground p-0 px-1 py-0.5 focus:bg-muted"
                              />
                            </div>
                            <div className="flex items-center gap-2">
                              <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-normal">
                              ...
                              <div className="relative">
                                <span className="absolute left-0 top-1/2 -translate-y-1/2 text-[9px] font-semibold text-success/40">
                                  R$
                                </span>
                                <input
                                  ...
                                  className="w-20 bg-muted/40 border-none rounded-lg text-xs font-semibold text-right text-success p-0 pl-4 px-1 py-0.5 focus:bg-muted tabular-nums"
                                />
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="flex flex-col items-end gap-1 px-4 border-l border-border/50">
                          ...
                          <span className="text-sm font-semibold text-primary tabular-nums tracking-tighter">
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center gap-6 border-2 border-dashed border-border rounded-[var(--radius-lg)] bg-muted/5 opacity-60">
                      ...
                      <div className="text-center space-y-1">
                        <p className="text-sm font-semibold text-foreground uppercase tracking-normal">
                          Nenhum Serviço Composto
                        </p>
                        <p className="text-[10px] text-muted-foreground font-medium max-w-[200px]">
                          Utilize o seletor lateral para compor a ficha técnica desta OS.
                        </p>
                      </div>
                    </div>
                  )}
            ...
            <div className="flex items-center justify-between pb-8 border-b border-border/50 relative">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <Muted className="text-[10px] font-semibold uppercase tracking-normal">
                    Metadados da produção e cronograma
                  </Muted>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
              ...
              <div className="md:col-span-2 group/field relative">
                ...
                <div className="relative max-w-md">
                  ...
                  <input
                    ...
                    className={cn(
                      inputClass,
                      'pl-16 bg-primary/5 border-primary/20 text-primary font-semibold text-lg focus:ring-primary/10 tracking-tight cursor-pointer',
                    )}
                  />
                </div>
              </div>

              <div className="md:col-span-2 rounded-lg border border-border/60 bg-muted/20 p-6">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div className="group/field relative">
                    ...
                    <button
                      ...
                      className={cn(
                        'w-full rounded-xl border px-4 py-3 text-left text-xs font-semibold uppercase tracking-normal transition-all',
                        isUrgent
              ...
              <div className="md:col-span-2 group/field relative">
                <label className={labelClass}>
                  Instruções Laboratoriais / Observações Técnicas
                </label>
                <div className="relative">
                  <textarea
          ...
          <ScaleIn className="p-8 flex flex-col gap-10">
            <div className="flex items-center justify-between pb-8 border-b border-border/50 relative">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <Muted className="text-[10px] font-semibold uppercase tracking-normal text-success">
                    Validação de faturamento e registro OS
                  </Muted>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative">
              ...
              <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-8 rounded-lg bg-muted/40 border border-border/50 flex flex-col gap-6 relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 relative">
                    <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-card border border-border shadow-inner font-semibold text-primary text-xs">
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      {osNumber && (
                        <span className="text-[10px] font-bold text-primary uppercase tracking-normal leading-none">
                          OS Física # {osNumber}
                        </span>
                      )}
                    </div>
                ...
                <div className="p-8 rounded-lg bg-muted/40 border border-border/50 flex flex-col gap-6 relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 relative">
                    <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-card border border-border shadow-inner text-primary">
                      <Calendar size={22} strokeWidth={2.5} />
                    </div>
                    <div className="flex flex-col gap-0.5">
                      <span className="text-sm font-semibold text-foreground tracking-tight uppercase">
                        {details.patientName || 'Paciente não informado'}
                      </span>
                      <span className="text-[10px] font-bold text-primary tracking-normal leading-none uppercase">
                        Entrega em{' '}
                        {details.deadline
                ...
                <div className="p-8 rounded-lg bg-primary/[0.04] border-2 border-primary/20 flex flex-col gap-6 relative shadow-sm">
                  ...
                  <div className="flex flex-col gap-1 relative">
                    <Large className="text-4xl font-semibold text-primary tracking-tighter tabular-nums leading-none">
                      {formatBRL(totalCents)}
                    </Large>
                    <Muted className="text-[9px] font-bold uppercase tracking-normal text-primary/60">
                      {items.length} Serviço(s) Composto(s)
                    </Muted>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-12 p-10 rounded-[var(--radius-lg)] bg-card border border-border/60 shadow-xl overflow-hidden group/audit relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative items-start">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs font-semibold text-foreground tracking-tight leading-tight uppercase bg-muted/30 p-3 rounded-xl border border-border/40 italic">
                      {details.prothesisType || 'Não definida'}
                    </p>
                  </div>
                  <div className="space-y-2">
                    <span className="text-[9px] font-semibold text-muted-foreground uppercase tracking-normal opacity-60">
            ...
            {error && (
              <div className="p-6 bg-destructive/10 border-2 border-destructive/20 rounded-[var(--radius-lg)] flex items-center gap-4 animate-bounce shadow-xl shadow-sm">
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="text-[10px] font-semibold text-destructive uppercase tracking-normal">
                    Inconsistência de Registro
                  </span>
                  <p className="text-sm font-semibold text-destructive tracking-tight leading-tight">
                    {error}
                  </p>
                </div>
              </div>
        ...
        <div className="flex gap-4 max-w-5xl mx-auto w-full">
          {step > 0 && (
            <button
              ...
              className="flex-1 max-w-[160px] py-6 rounded-lg bg-muted/40 border border-border text-muted-foreground text-[10px] font-semibold uppercase tracking-normal hover:bg-muted hover:text-foreground transition-all duration-300 flex items-center justify-center gap-3  group shadow-sm"
            >
              <ArrowLeft
                size={16}
                strokeWidth={3}
