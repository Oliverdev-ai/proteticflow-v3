...
export default function ClientPortalManagementPage() {
  ...
  if (!clientId) {
    return <div className="text-sm text-[var(--destructive)]">Cliente invalido.</div>;
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Gestao de token de acesso publico por cliente.</p>
        </div>
      </div>
