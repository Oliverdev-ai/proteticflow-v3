...
export function PredictionCard({ title, prediction, confidence, type }: Props) {
  ...
  return (
    <div className="relative overflow-hidden rounded-lg border border-border bg-muted p-6 backdrop-blur transition-all hover:bg-muted shadow-sm hover:shadow-sm hover:border-primary/30">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-3 relative z-10 w-full">
          ...
          <p className="text-base text-muted-foreground pr-4">{prediction}</p>
