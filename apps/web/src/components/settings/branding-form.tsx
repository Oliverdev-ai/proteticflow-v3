...
export function BrandingForm() {
  ...
  return (
    <div className="bg-card/30 backdrop-blur-sm border border-border/50 rounded-lg p-8 flex flex-col gap-10 relative overflow-hidden group/brand">
        <div className="flex items-center gap-4 relative">
           <div className="w-10 h-10 rounded-xl bg-primary/10 text-primary flex items-center justify-center shadow-inner">
              <Palette size={18} strokeWidth={3} />
           </div>
           <div className="flex flex-col gap-0.5">
              <Large className="tracking-tight text-lg font-semibold uppercase">DNA Visual da Marca</Large>
              <Muted className="text-[10px] font-semibold uppercase tracking-normal opacity-40">Personalização de interface e documentos PDF</Muted>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 relative">
           ...
           <div className="flex flex-col gap-6">
              <div className="flex items-center gap-2 mb-2">
                 ...
                 <span className="text-[10px] font-semibold uppercase tracking-normal text-muted-foreground">Esquema Cromático</span>
              </div>
              ...
              <div className="p-5 bg-muted/20 border border-border rounded-lg flex items-center gap-4 group/preview overflow-hidden">
                 ...
                 <div className="flex flex-col gap-0.5">
                    <span className="text-[9px] font-semibold uppercase tracking-normal text-foreground">Amostra de Contraste</span>
                    <span className="text-[8px] font-bold uppercase tracking-normal text-muted-foreground opacity-40 italic">Preview em tempo real</span>
                 </div>
              </div>
           </div>
           ...
           <div className="flex flex-col gap-6">
              <div className="flex items-center gap-2 mb-2">
                 ...
                 <span className="text-[10px] font-semibold uppercase tracking-normal text-muted-foreground">Documentação (PDF)</span>
              </div>
        ...
        <div className="flex items-center justify-end gap-4 border-t border-border/50 pt-8 mt-2 relative">
           {updateBranding.isSuccess && (
             <div className="flex items-center gap-2 text-success animate-in fade-in slide-in-from-right-4">
                ...
                <span className="text-[10px] font-semibold uppercase tracking-normal">Branding Sincronizado</span>
             </div>
           )}
           <div className="flex items-center gap-3">
              <div className="px-4 py-2 bg-muted rounded-xl border border-border flex items-center gap-2">
                 ...
                 <span className="text-[9px] font-semibold uppercase tracking-normal text-muted-foreground">Preview Global Habilitado</span>
              </div>
              <button
