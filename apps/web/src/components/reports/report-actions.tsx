...
export function ReportActions(props: ReportActionsProps) {
  const btnClass = "flex-1 min-w-[140px] flex items-center justify-center gap-2.5 px-6 py-4 rounded-lg text-[10px] font-semibold uppercase tracking-normal transition-all  disabled:opacity-30 disabled:grayscale shadow-sm";
    ...
    <div className="premium-card p-10 flex flex-col gap-10 relative overflow-hidden group">
      <div className="flex items-center gap-4 relative">
         ...
         <div className="flex flex-col gap-0.5">
            ...
            <Muted className="text-[10px] font-semibold uppercase tracking-normal">Ações e distribuição de inteligência</Muted>
         </div>
      </div>
      ...
      <div className="flex flex-col gap-8 relative">
         ...
         <div className="flex flex-wrap gap-4">
            <button 
               ...
               className={cn(btnClass, "bg-primary text-primary-foreground shadow-sm hover:brightness-110")}
            >
            ...
            <button 
               ...
               disabled={props.disabled} 
               className={cn(btnClass, "bg-muted border border-border text-foreground hover:bg-muted/80 hover:text-success hover:border-success/50")}
            >
         ...
         <div className="flex flex-col gap-4 pt-6 border-t border-border/50">
            <div className="flex items-center gap-2 ml-1">
               ...
               <Muted className="text-[10px] font-semibold uppercase tracking-normal">Distribuição por E-mail</Muted>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
               <div className="flex-1 min-w-[280px] relative group/email">
                  ...
                  <input
                    ...
                    className="w-full bg-muted/50 border border-border rounded-lg pl-16 pr-6 py-5 text-sm font-semibold text-foreground placeholder:text-muted-foreground/30 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary/50 transition-all shadow-inner tracking-tighter"
                  />
                  {props.email && (
               ...
               <button 
                  ...
                  className="flex items-center justify-center gap-3 px-8 py-5 rounded-lg bg-amber-500 text-white text-[10px] font-semibold uppercase tracking-normal shadow-lg shadow-sm hover:brightness-110  disabled:opacity-30 transition-all min-w-[200px]"
               >
