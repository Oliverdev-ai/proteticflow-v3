    ...
    <div className="premium-card p-6 grid grid-cols-1 md:grid-cols-5 gap-6 items-end relative overflow-hidden group">
      ...
      <div className="flex items-center gap-6 h-10 md:col-span-2 px-2">
        <label className="flex items-center gap-3 cursor-pointer group/check">
          ...
          <span className="text-[10px] font-semibold uppercase tracking-normal text-muted-foreground group-hover/check:text-primary transition-colors">Gráficos</span>
        </label>
        ...
        <label className="flex items-center gap-3 cursor-pointer group/check">
          ...
          <span className="text-[10px] font-semibold uppercase tracking-normal text-muted-foreground group-hover/check:text-primary transition-colors">Breakdown</span>
        </label>
      </div>
